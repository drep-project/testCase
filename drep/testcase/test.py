...
if __name__ == '__main__':
	...
	account_list, list_account = getBalance_of_all_address_list(api_name="chain_getBalance", address=address_list)
	# print(list_account)
	save_balance_accou(account_list, list_account)
